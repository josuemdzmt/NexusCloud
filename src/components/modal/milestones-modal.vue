            ...
            <div class="max-w-[420px] w-full mx-auto">
                <div class="bg-white rounded-md pointer-events-auto p-5">
                    <div class="flex items-center justify-between mb-5">
                        <h2 class="text-base font-bold text-gray-900 mb-0">Add Milestone</h2>
                    ...
                    <form class="space-y-4">
                        <div>
                            <label class="text-sm font-semibold text-gray-900 mb-1 inline-block">Milestone Name <span class="text-danger">*</span></label>
                        ...
                        <div>
                            <label class="text-sm font-semibold text-gray-900 mb-1 inline-block">Project Name <span class="text-danger">*</span></label>
                        ...
                        <div>
                            <label class="text-sm font-semibold text-gray-900 mb-1 inline-block">Owner <span class="text-danger">*</span></label>
                            <select class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-white focus:outline-none focus:ring-0">
                                <option>Select</option>
                        ...
                        <div>
                            ...
                            <a-date-picker v-model:value="milestoneDate" class="w-full" placeholder="dd/mm/yyyy" />
                        </div>
    ...
    <div id="edit-modal" class="hs-overlay hs-overlay-open:opacity-100 hs-overlay-open:duration-300 hidden size-full fixed top-0 start-0 z-80 opacity-0 overflow-x-hidden transition-all overflow-y-auto pointer-events-none" role="dialog" tabindex="-1">
        <div class="min-h-screen flex items-center justify-center px-4">
            <div class="max-w-[420px] w-full mx-auto">
                <div class="bg-white rounded-md pointer-events-auto p-5">
                    <div class="flex items-center justify-between mb-5">
                        <h2 class="text-base font-bold text-gray-900 mb-0">Edit Milestone</h2>
                    ...
                    <form class="space-y-4">
                        <div>
                            <label class="text-sm font-semibold text-gray-900 mb-1 inline-block">Milestone Name <span class="text-danger">*</span></label>
                            <input type="text" class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-white focus:outline-none focus:ring-0" value="Requirement Gathering">
                        </div>
                        <div>
                            <label class="text-sm font-semibold text-gray-900 mb-1 inline-block">Project Name <span class="text-danger">*</span></label>
                            <select class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-white focus:outline-none focus:ring-0">
                        ...
                        <div>
                            <label class="text-sm font-semibold text-gray-900 mb-1 inline-block">Date <span class="text-danger">*</span></label>
                            <a-date-picker v-model:value="editMilestoneDate" class="w-full" placeholder="dd/mm/yyyy" />
                        </div>
                        <div class="flex items-center justify-between gap-3 mt-5">
