    ...
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex items-center flex-wrap gap-1 border-b border-border-color mb-4">
                ...
                <router-link :to="all_routes.workflowRequests" class="px-4 py-2 text-sm text-default hover:text-gray-900">Requests</router-link>
                <router-link :to="all_routes.workflowActions" class="px-4 py-2 text-sm font-semibold text-gray-900 border-b-2 border-primary -mb-px">Actions / Audit</router-link>
            </div>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                ...
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Actor</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Date</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Comment</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color last:border-0">
                                <td class="py-2.5 px-2">
                                    <a href="#" class="text-sm text-default hover:text-primary">#ACT0020</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">#WFL0020</td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Dept Manager</td>
                                <td class="py-2.5 px-2 text-sm text-default">11 Sep 2025</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">Looks OK - forward to Finance</td>
                            ...
                            <tr class="border-b border-border-color last:border-0">
                                <td class="py-2.5 px-2">
                                    <a href="#" class="text-sm text-default hover:text-primary">#ACT0019</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">#WFL0019</td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Procurement Officer</td>
                                <td class="py-2.5 px-2 text-sm text-default">05 Sep 2025</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">Vendor verified</td>
                            ...
                            <tr class="border-b border-border-color last:border-0">
                                <td class="py-2.5 px-2">
                                    <a href="#" class="text-sm text-default hover:text-primary">#ACT0018</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">#WFL0018</td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Line Manager</td>
                                <td class="py-2.5 px-2 text-sm text-default">27 Aug 2025</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">Dept - level OK</td>
                            ...
                            <tr class="border-b border-border-color last:border-0">
                                <td class="py-2.5 px-2">
                                    <a href="#" class="text-sm text-default hover:text-primary">#ACT0017</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">#WFL0017</td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">HR Manager</td>
                                <td class="py-2.5 px-2 text-sm text-default">16 Aug 2025</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">Too long leave in quarter - end</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Approved</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color last:border-0">
                                <td class="py-2.5 px-2">
                                    <a href="#" class="text-sm text-default hover:text-primary">#ACT0016</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">#WFL0016</td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Project Manager</td>
                                <td class="py-2.5 px-2 text-sm text-default">25 Jul 2025</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">Hours OK</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">Pending</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color last:border-0">
                                <td class="py-2.5 px-2">
                                    <a href="#" class="text-sm text-default hover:text-primary">#ACT0015</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">#WFL0015</td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Compliance Officer</td>
                                <td class="py-2.5 px-2 text-sm text-default">12 Jul 2025</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">Compliant</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">Rejected</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color last:border-0">
                                <td class="py-2.5 px-2">
                                    <a href="#" class="text-sm text-default hover:text-primary">#ACT0014</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">#WFL0014</td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Asset Manager</td>
                                <td class="py-2.5 px-2 text-sm text-default">23 Jun 2025</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">Valuation requested from vendor</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Approved</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color last:border-0">
                                <td class="py-2.5 px-2">
                                    <a href="#" class="text-sm text-default hover:text-primary">#ACT0013</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">#WFL0013</td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Sales Manager</td>
                                <td class="py-2.5 px-2 text-sm text-default">07 Jun 2025</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">Need client approval on pricing</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">Pending</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color last:border-0">
                                <td class="py-2.5 px-2">
                                    <a href="#" class="text-sm text-default hover:text-primary">#ACT0012</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">#WFL0012</td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">IT Team Lead</td>
                                <td class="py-2.5 px-2 text-sm text-default">28 May 2025</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">Access provisioned (temporary)</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">Rejected</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color last:border-0">
                                <td class="py-2.5 px-2">
                                    <a href="#" class="text-sm text-default hover:text-primary">#ACT0011</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">#WFL0011</td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Legal Counsel</td>
                                <td class="py-2.5 px-2 text-sm text-default">18 May 2025</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">Redlines added - awaiting vendor sign</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Approved</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
