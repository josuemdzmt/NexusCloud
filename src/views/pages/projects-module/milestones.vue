<template>
    <main>
        ...
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl max-lg:text-lg font-bold mb-0">Milestones</h1>
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                <div class="p-2 space-y-1">
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0" checked>Office Management App</label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0">Clinic Management</label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0">Educational Platform</label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0">Hotel Booking App</label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0">POS Admin Software</label>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><a href="#" class="text-sm text-default hover:text-primary">#MLS0020</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Requirement Gathering</td>
                                ...
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Completed</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><a href="#" class="text-sm text-default hover:text-primary">#MLS0019</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Design Phase</td>
                                ...
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">On Hold</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                            <i class="icon-ellipsis-vertical font-normal"></i>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><a href="#" class="text-sm text-default hover:text-primary">#MLS0018</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">First Pass API</td>
                                ...
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-info-transparent text-info px-2 py-0.5 rounded">In Progress</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                            <i class="icon-ellipsis-vertical font-normal"></i>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><a href="#" class="text-sm text-default hover:text-primary">#MLS0017</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">App Store Submission</td>
                                ...
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-purple-transparent text-purple px-2 py-0.5 rounded">Planned</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                            <i class="icon-ellipsis-vertical font-normal"></i>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><a href="#" class="text-sm text-default hover:text-primary">#MLS0016</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Beta Release</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><a href="#" class="text-sm text-default hover:text-primary">#MLS0015</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Design Phase</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><a href="#" class="text-sm text-default hover:text-primary">#MLS0014</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Development Phase</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><a href="#" class="text-sm text-default hover:text-primary">#MLS0013</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Beta Release</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><a href="#" class="text-sm text-default hover:text-primary">#MLS0012</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">App Store Submission</td>
                            ...
                            <tr>
                                <td class="py-2.5 px-2"><a href="#" class="text-sm text-default hover:text-primary">#MLS0011</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Design Phase</td>
    ...
    <milestones-modal></milestones-modal>
</template>
