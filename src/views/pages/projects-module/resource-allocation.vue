<template>
    <main>
        ...
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl max-lg:text-lg font-bold mb-0">Resource Allocation</h1>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Resource</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Role</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Allocated</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Project Name</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Availability</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">UI/UX Designer</td>
                            ...
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">70%</td>
                            ...
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">Tester</td>
                                <td class="py-2.5 px-2 text-sm text-default">50%</td>
                            ...
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">Marketing Manager</td>
                                <td class="py-2.5 px-2 text-sm text-default">50%</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Hendrita Bennett</span>
                                    </div>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">Administrator</td>
                                <td class="py-2.5 px-2 text-sm text-default">40%</td>
                            ...
                            <tr>
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Harper Scott</span>
                                    </div>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">Team Lead</td>
                                <td class="py-2.5 px-2 text-sm text-default">70%</td>
    ...
    <resource-allocation-modal></resource-allocation-modal>
</template>
