<template>
    <main>
        ...
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl max-lg:text-lg font-bold mb-0">SLA Management</h1>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                ...
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Response Time</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Resolution Time</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#SLA0020</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Standard Support</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Low</span></td>
                                <td class="py-2.5 px-2 text-sm text-default">4 hrs</td>
                                <td class="py-2.5 px-2 text-sm text-default">24 hrs</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#SLA0019</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Critical Incident Support</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">Medium</span></td>
                                <td class="py-2.5 px-2 text-sm text-default">1 hr</td>
                                <td class="py-2.5 px-2 text-sm text-default">4 hrs</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#SLA0018</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Premium Customer Support</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">High</span></td>
                                <td class="py-2.5 px-2 text-sm text-default">2 hrs</td>
                                <td class="py-2.5 px-2 text-sm text-default">12 hrs</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#SLA0017</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Onboarding Assistance</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Low</span></td>
                                <td class="py-2.5 px-2 text-sm text-default">8 hrs</td>
                                <td class="py-2.5 px-2 text-sm text-default">48 hrs</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Active</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#SLA0016</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Technical Escalation</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">Medium</span></td>
                                <td class="py-2.5 px-2 text-sm text-default">30 mins</td>
                                <td class="py-2.5 px-2 text-sm text-default">2 hrs</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">Pending</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#SLA0015</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Billing Issue Resolution</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">High</span></td>
                                <td class="py-2.5 px-2 text-sm text-default">4 hrs</td>
                                <td class="py-2.5 px-2 text-sm text-default">24 hrs</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">Expired</span></td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#SLA0014</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Software Upgrade Support</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Low</span></td>
                                <td class="py-2.5 px-2 text-sm text-default">6 hrs</td>
                                <td class="py-2.5 px-2 text-sm text-default">36 hrs</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Active</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#SLA0013</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Hardware Replacement</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">Medium</span></td>
                                <td class="py-2.5 px-2 text-sm text-default">2 hrs</td>
                                <td class="py-2.5 px-2 text-sm text-default">8 hrs</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">Pending</span></td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#SLA0012</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Customer Query Resolution</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">High</span></td>
                                <td class="py-2.5 px-2 text-sm text-default">15 hrs</td>
                                <td class="py-2.5 px-2 text-sm text-default">72 hrs</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">Expired</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr>
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#SLA0011</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Emergency Outage Support</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Low</span></td>
                                <td class="py-2.5 px-2 text-sm text-default">45 mins</td>
                                <td class="py-2.5 px-2 text-sm text-default">2 hrs</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Active</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
    ...
    <sla-management-modal></sla-management-modal>
</template>
