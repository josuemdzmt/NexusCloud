    ...
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl font-bold mb-0">Cashflow</h1>
                <div class="flex items-center gap-2">
                    ...
                    <button type="button" class="btn-sm bg-dark text-white border border-dark inline-flex items-center gap-2 hover:bg-primary-hover cursor-pointer" data-hs-overlay="#add-cashflow-modal">
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                <div class="p-2 space-y-1">
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0" checked> Chase Bank 
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Wells Fargo 
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Bank of America 
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Capital One 
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Citi Bank 
                                    </label> 
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Ref</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#CF0020</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Chase Bank</td>
                                <td class="py-2.5 px-2 text-sm text-default">Inflow</td>
                                <td class="py-2.5 px-2 text-sm text-default">Bank Transfer</td>
                                <td class="py-2.5 px-2 text-sm text-success">+$25,000</td>
                                ...
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                            <div class="p-2 space-y-1">
                                                <a class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" href="#" data-hs-overlay="#edit-cashflow-modal">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#CF0019</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">HSBC</td>
                                <td class="py-2.5 px-2 text-sm text-default">Outflow</td>
                                <td class="py-2.5 px-2 text-sm text-default">Wire Transfer</td>
                                <td class="py-2.5 px-2 text-sm text-danger">-$8,500</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#CF0018</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Wells Fargo</td>
                                <td class="py-2.5 px-2 text-sm text-default">Inflow</td>
                                <td class="py-2.5 px-2 text-sm text-default">UPI</td>
                                <td class="py-2.5 px-2 text-sm text-success">+$12,300</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#CF0017</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Chase Bank</td>
                                <td class="py-2.5 px-2 text-sm text-default">Outflow</td>
                                <td class="py-2.5 px-2 text-sm text-default">Cheque</td>
                                <td class="py-2.5 px-2 text-sm text-danger">-$15,750</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#CF0016</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Bank of America</td>
                                <td class="py-2.5 px-2 text-sm text-default">Inflow</td>
                                <td class="py-2.5 px-2 text-sm text-default">Bank Transfer</td>
                                <td class="py-2.5 px-2 text-sm text-success">+$45,800</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#CF0015</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">HSBC</td>
                                <td class="py-2.5 px-2 text-sm text-default">Outflow</td>
                                <td class="py-2.5 px-2 text-sm text-default">Wire Transfer</td>
                                <td class="py-2.5 px-2 text-sm text-danger">-$22,100</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#CF0014</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Wells Fargo</td>
                                <td class="py-2.5 px-2 text-sm text-default">Inflow</td>
                                <td class="py-2.5 px-2 text-sm text-default">UPI</td>
                                <td class="py-2.5 px-2 text-sm text-success">+$18,500</td>
                            ...
                            <tr>
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#CF0013</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Chase Bank</td>
                                <td class="py-2.5 px-2 text-sm text-default">Outflow</td>
                                <td class="py-2.5 px-2 text-sm text-default">Bank Transfer</td>
                                <td class="py-2.5 px-2 text-sm text-danger">-$9,200</td>
