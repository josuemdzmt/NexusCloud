    ...
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl font-bold mb-0">Expenses</h1>
                <div class="flex items-center gap-2">
                    ...
                    <button type="button" class="btn-sm bg-dark text-white border border-dark inline-flex items-center gap-2 hover:bg-primary-hover cursor-pointer" data-hs-overlay="#add-expense-modal">
                ...
                <div class="flex flex-wrap items-center justify-between gap-3 mb-3">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="hs-dropdown [--placement:bottom-left] [--auto-close:inside] relative inline-flex">
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                <div class="p-2 space-y-1">
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white"><input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0" checked> Office Supplies </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white"><input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Travel</label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white"><input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Rent</label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white"><input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Utilities</label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white"><input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Marketing</label> 
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Expense ID</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Expense Name</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#EXP0020</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Stationery Purchase</td>
                                <td class="py-2.5 px-2 text-sm text-default">Office Supplies</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900 text-left">$10,000</td>
                                ...
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                            <div class="p-2 space-y-1">
                                                <a class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" href="#" data-hs-overlay="#edit-expense-modal">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#EXP0019</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Sales Team Flights</td>
                                <td class="py-2.5 px-2 text-sm text-default">Travel</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900 text-left">$5,000</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#EXP0018</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Utility Bill</td>
                                <td class="py-2.5 px-2 text-sm text-default">Utilities</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900 text-left">$25,000</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#EXP0017</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Office Rent</td>
                                <td class="py-2.5 px-2 text-sm text-default">Rent</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900 text-left">$15,500</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#EXP0016</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Google Ad Campaign</td>
                                <td class="py-2.5 px-2 text-sm text-default">Marketing</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900 text-left">$34,000</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#EXP0015</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Cloud Hosting Fees</td>
                                <td class="py-2.5 px-2 text-sm text-default">IT Services</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900 text-left">$28,000</td>
                                <td class="py-2.5 px-2 text-sm text-default">Cash</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#EXP0014</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Local Transport</td>
                                <td class="py-2.5 px-2 text-sm text-default">Travel</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900 text-left">$1,45,000</td>
                                <td class="py-2.5 px-2 text-sm text-default">Credit Card</td>
                            ...
                            <tr>
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#EXP0013</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Leadership Training</td>
                                <td class="py-2.5 px-2 text-sm text-default">Employee Training</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900 text-left">$2,70,000</td>
                                <td class="py-2.5 px-2 text-sm text-default">Debit Card</td>
