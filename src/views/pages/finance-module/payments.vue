    ...
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl font-bold mb-0">Payments</h1>
                <div class="flex items-center gap-2">
                    ...
                    <button type="button" class="btn-sm bg-dark text-white border border-dark inline-flex items-center gap-2 hover:bg-primary-hover cursor-pointer" data-hs-overlay="#add-payments-modal"><i class="ph ph-plus"></i> Add New</button>
                </div>
            </div>
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                <div class="p-2 space-y-1">
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0" checked> Alpha Supplies Inc </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Beta Logistics Ltd</label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Star Printers Co </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Quick Rentals </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Bright Cleaning </label> 
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                ...
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Bank</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#PAY0020</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Alpha Supplies Inc</td>
                                <td class="py-2.5 px-2 text-sm text-default">Chase Bank</td>
                                <td class="py-2.5 px-2 text-sm text-default">Bank Transfer</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">$22,500</td>
                                ...
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                            <div class="p-2 space-y-1">
                                                <a class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" href="#" data-hs-overlay="#edit-payments-modal">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#PAY0019</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Beta Logistics Ltd</td>
                                <td class="py-2.5 px-2 text-sm text-default">HSBC</td>
                                <td class="py-2.5 px-2 text-sm text-default">UPI</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">$15,750</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#PAY0018</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Star Printers Co</td>
                                <td class="py-2.5 px-2 text-sm text-default">Wells Fargo</td>
                                <td class="py-2.5 px-2 text-sm text-default">Credit Card</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">$8,600</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#PAY0017</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Quick Rentals</td>
                                <td class="py-2.5 px-2 text-sm text-default">Bank of America</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#PAY0016</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Bright Cleaning</td>
                                <td class="py-2.5 px-2 text-sm text-default">Chase Bank</td>
                                <td class="py-2.5 px-2 text-sm text-default">Bank Transfer</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">$28,400</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#PAY0015</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Green Cafe Supplies</td>
                                <td class="py-2.5 px-2 text-sm text-default">HSBC</td>
                                <td class="py-2.5 px-2 text-sm text-default">UPI</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">$6,400</td>
                            ...
                            <tr>
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#PAY0014</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Tech Soft Ltd</td>
                                <td class="py-2.5 px-2 text-sm text-default">Wells Fargo</td>
                                <td class="py-2.5 px-2 text-sm text-default">Credit Card</td>
                                <td class="py-2.5 px-2 text-sm text-gray-900">$11,300</td>
