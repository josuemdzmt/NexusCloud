    ...
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl font-bold mb-0">Holidays</h1>
                <div class="flex items-center gap-2">
                    ...
                    <button type="button" class="btn-sm bg-dark text-white border border-dark inline-flex items-center gap-2 hover:bg-primary-hover cursor-pointer" data-hs-overlay="#add-holiday-modal"><i class="ph ph-plus"></i> Add New</button>
                </div>
            </div>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Holiday Name</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Date</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Day</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">New Year's Day</td>
                                <td class="py-2.5 px-2 text-sm text-default">01 Jan 2026</td>
                                <td class="py-2.5 px-2 text-sm text-default">Thursday</td>
                                <td class="py-2.5 px-2 text-sm text-default">Public</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Upcoming</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                            <div class="p-2 space-y-1">
                                                <a class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" href="#" data-hs-overlay="#edit-holiday-modal">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Independence Day</td>
                                <td class="py-2.5 px-2 text-sm text-default">04 Jul 2026</td>
                                <td class="py-2.5 px-2 text-sm text-default">Saturday</td>
                                <td class="py-2.5 px-2 text-sm text-default">Public</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Upcoming</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Labor Day</td>
                                <td class="py-2.5 px-2 text-sm text-default">07 Sep 2026</td>
                                <td class="py-2.5 px-2 text-sm text-default">Monday</td>
                                <td class="py-2.5 px-2 text-sm text-default">Public</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Upcoming</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Thanksgiving Day</td>
                                <td class="py-2.5 px-2 text-sm text-default">26 Nov 2026</td>
                                <td class="py-2.5 px-2 text-sm text-default">Thursday</td>
                                <td class="py-2.5 px-2 text-sm text-default">Public</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Upcoming</span></td>
                                <td class="py-2.5 px-2">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Christmas Day</td>
                                <td class="py-2.5 px-2 text-sm text-default">25 Dec 2026</td>
                                <td class="py-2.5 px-2 text-sm text-default">Friday</td>
                                <td class="py-2.5 px-2 text-sm text-default">Public</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Upcoming</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Memorial Day</td>
                                <td class="py-2.5 px-2 text-sm text-default">25 May 2026</td>
                                <td class="py-2.5 px-2 text-sm text-default">Monday</td>
                                <td class="py-2.5 px-2 text-sm text-default">Public</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">This Week</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                            <i class="icon-ellipsis-vertical font-normal"></i>
                            ...
                            <tr>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Veterans Day</td>
                                <td class="py-2.5 px-2 text-sm text-default">11 Nov 2026</td>
                                <td class="py-2.5 px-2 text-sm text-default">Wednesday</td>
                                <td class="py-2.5 px-2 text-sm text-default">Public</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Upcoming</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
