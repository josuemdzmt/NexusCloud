<template>
  <nx-modal-form ref="modalFormRef" id="customer-modal" :title="strTitle" size="3xl" :validationSchema="objValidationSchema" :initialValues="objInitialData" @submit="handleSubmit" @cancel="handleCancel">
    <template #default="{ errors }">
      <div class="grid grid-cols-2 gap-3">
        ...
        <nx-address-fields name-prefix="shipping_address" searchable />
  ...
  methods: {
    ...
    handleSubmit(values) {
      const objPayload = {
        ...
        shipping_address: handleAddressPayload(values.shipping_address)
      };
      if (this.recordId) {
