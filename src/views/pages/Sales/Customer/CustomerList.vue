  ...
  <main>
    <div class="p-3 lg:py-6 lg:px-0">
      <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
        <h1 class="text-gray-900 text-xl font-bold mb-0">Clientes</h1>
...
export default {
  ...
  methods: {
    ...
    handleGetData() {
      this.bSpinner = true;
      CustomerService.getAll(handlePagerParams(this.currentPage, this.pageSize))
        .then((objResponse) => {
    ...
    handleRowAction(objEvent) {
      ...
      if (action.name === 'details') {
        this.$router.push(`/sales/customer/${row.id}/details`);
