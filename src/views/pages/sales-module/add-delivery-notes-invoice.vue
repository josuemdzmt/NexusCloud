        ...
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <div class="flex items-center gap-2">
                    ...
                    <h1 class="text-gray-900 text-base font-bold mb-0">Create New Delivery Note</h1>
                </div>
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <i class="ph ph-calendar-blank absolute right-3 top-1/2 -translate-y-1/2 text-gray-400">
                                </i>
                            </div>
                        </div>
                        <div class="mb-4">
