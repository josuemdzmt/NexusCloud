    ...
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl max-lg:text-lg font-bold mb-0">Sales Quotes</h1>
                <div class="flex items-center flex-wrap gap-2">
                    ...
                    <router-link :to="all_routes.addSalesQuotes" class="btn-sm bg-dark text-white border border-dark inline-flex items-center gap-2 hover:bg-primary-hover cursor-pointer"><i class="ph ph-plus"></i> Add New</router-link>
                </div>
            </div>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Quote ID</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Customer</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Quote Date</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Expiry Date</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.salesDetails" class="text-sm text-default hover:text-primary">#SQ0020</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Accepted</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                            <div class="p-2 space-y-1">
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.salesQuotesDetails"> <i class="icon-eye"></i> Preview </router-link>
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.editSalesQuotes"> <i class="icon-pencil-line"></i> Edit </router-link>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.salesDetails" class="text-sm text-default hover:text-primary">#SQ0019</router-link>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.salesDetails" class="text-sm text-default hover:text-primary">#SQ0018</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">11 Sep 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">$5,600</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">Expired</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown"> <i class="icon-ellipsis-vertical font-normal"></i> </button>
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.salesDetails" class="text-sm text-default hover:text-primary">#SQ0017</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">$9,200</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Accepted</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown"> <i class="icon-ellipsis-vertical font-normal"></i> </button>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.salesDetails" class="text-sm text-default hover:text-primary">#SQ0016</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">$15,800</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-info-transparent text-info px-2 py-0.5 rounded">Sent</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown"> <i class="icon-ellipsis-vertical font-normal"></i> </button>
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.salesDetails" class="text-sm text-default hover:text-primary">#SQ0015</router-link>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.salesDetails" class="text-sm text-default hover:text-primary">#SQ0014</router-link>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.salesDetails" class="text-sm text-default hover:text-primary">#SQ0013</router-link>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.salesDetails" class="text-sm text-default hover:text-primary">#SQ0012</router-link>
                                </td>
                            ...
                            <tr>
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.salesDetails" class="text-sm text-default hover:text-primary">#SQ0011</router-link>
                                </td>
