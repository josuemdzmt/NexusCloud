        ...
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <div class="flex items-center gap-2">
                    <router-link :to="all_routes.creditNotes" class="text-gray-900 hover:text-primary flex items-center text-sm">
                        <i class="ph ph-arrow-left"></i>
                    </router-link>
                    <h1 class="text-gray-900 text-base font-bold mb-0">Create New Credit Note</h1>
                </div>
                <div class="flex items-center gap-2">
                    <router-link :to="all_routes.creditNotesDetails" class="btn-sm bg-white border border-border-color text-gray-900 hover:bg-light cursor-pointer rounded-md shadow-sm inline-flex items-center">
            ...
            <div class="bg-white border border-border-color rounded-md p-5 shadow-sm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6 pb-6 border-b border-border-color">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-gray-900 mb-5">Credit Note Details</h2>
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                <label class="text-sm font-semibold text-gray-900 mb-2 block">Credit Note ID 
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-gray-50 focus:outline-none focus:ring-0 text-gray-600 dark:bg-gray-100" value="CN0001" readonly>
                            </div>
                            <div>
