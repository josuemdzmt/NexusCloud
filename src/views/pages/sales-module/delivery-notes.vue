    ...
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl font-bold mb-0">Delivery Notes</h1>
                <div class="flex items-center gap-2">
                    ...
                    <router-link :to="all_routes.addDeliveryNotesInvoice" class="btn-sm bg-dark text-white border border-dark inline-flex items-center gap-2 hover:bg-primary-hover cursor-pointer"><i class="ph ph-plus"></i> Add New</router-link>
                </div>
            </div>
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                <div class="p-2 space-y-1">
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0" checked> Alexander Hayes
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Ava Mitchell
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Andrew Collins 
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Amelia Scott 
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Anthony Walker 
                                    </label> 
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">DN ID</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Customer</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Order Ref</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Delivery Date</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Carrier</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DN0020</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Alexander Kenn</td>
                                <td class="py-2.5 px-2 text-sm text-default">#SO0020</td>
                                <td class="py-2.5 px-2 text-sm text-default">18 Sep 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">FedEx</td>
                                ...
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                            <div class="p-2 space-y-1">
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.deliveryNoteDetails"> 
                                                    <i class="icon-eye"></i> Preview 
                                                </router-link>
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.editDeliveryNotesInvoice"> 
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DN0019</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Gabriella White</td>
                                <td class="py-2.5 px-2 text-sm text-default">#SO0019</td>
                                <td class="py-2.5 px-2 text-sm text-default">12 Sep 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">DHL</td>
                                <td class="py-2.5 px-2 text-sm text-default">3</td>
                                <td class="py-2.5 px-2">
                                    <span class="text-[11px] bg-info-transparent text-info px-2 py-0.5 rounded">In Transit</span>
                                </td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown"> 
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DN0018</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Christopher Rey</td>
                                <td class="py-2.5 px-2 text-sm text-default">#SO0018</td>
                                <td class="py-2.5 px-2 text-sm text-default">04 Sep 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">UPS</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DN0017</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Penelope Ton</td>
                                <td class="py-2.5 px-2 text-sm text-default">#SO0017</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DN0016</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Daniel Foster</td>
                                <td class="py-2.5 px-2 text-sm text-default">#SO0016</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DN0015</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Anastasia Leton</td>
                                <td class="py-2.5 px-2 text-sm text-default">#SO0015</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DN0014</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Noah Bennett</td>
                                <td class="py-2.5 px-2 text-sm text-default">#SO0014</td>
                                <td class="py-2.5 px-2 text-sm text-default">30 Jun 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">FedEx</td>
                                <td class="py-2.5 px-2 text-sm text-default">6</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-info-transparent text-info px-2 py-0.5 rounded">In Transit</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown"> 
                                            <i class="icon-ellipsis-vertical font-normal"></i> 
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DN0013</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Victoria Ellsworth</td>
                                <td class="py-2.5 px-2 text-sm text-default">#SO0013</td>
                                <td class="py-2.5 px-2 text-sm text-default">14 Jun 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">DHL</td>
                                <td class="py-2.5 px-2 text-sm text-default">3</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">Failed</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown"> 
                                            <i class="icon-ellipsis-vertical font-normal"></i> 
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DN0012</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Noah Kensington</td>
                                <td class="py-2.5 px-2 text-sm text-default">#SO0012</td>
                            ...
                            <tr>
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DN0011</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Catherine Lan</td>
                                <td class="py-2.5 px-2 text-sm text-default">#SO0011</td>
                                ...
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                            <div class="p-2 space-y-1">
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.deliveryNoteDetails"> <i class="icon-eye"></i> Preview </router-link>
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.editDeliveryNotesInvoice"> 
                                                    <i class="icon-pencil-line"></i> Edit 
                                                </router-link>
                                                <a class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-danger hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" href="#" data-hs-overlay="#delete-modal"> 
