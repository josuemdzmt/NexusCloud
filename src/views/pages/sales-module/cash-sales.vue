    ...
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl max-lg:text-lg font-bold mb-0">Cash Sales</h1>
                <div class="flex items-center flex-wrap gap-2">
                    ...
                    <router-link :to="all_routes.addCashSales" class="btn-sm bg-dark text-white border border-dark inline-flex items-center gap-2 hover:bg-primary-hover cursor-pointer"><i class="ph ph-plus"></i> Add New</router-link>
                </div>
            </div>
            <div class="bg-white border border-border-color rounded-md p-4">
                <div class="flex flex-wrap items-center justify-between gap-3 mb-3">
                    ...
                    <div class="flex items-center flex-wrap gap-2">
                        ...
                        <button type="button" class="size-7 rounded-md border border-border-color flex items-center justify-center text-default hover:bg-light cursor-pointer"><i class="ph-duotone ph-columns"></i>
                        </button>
                        <button type="button" class="size-7 rounded-md border border-border-color flex items-center justify-center text-default hover:bg-light cursor-pointer"><i class="ph ph-arrow-clockwise"></i>
                        </button>
                    </div>
                </div>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Receipt ID</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.cashSalesDetails" class="text-sm text-default hover:text-primary">#CS0020</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                            <div class="p-2 space-y-1">
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.cashSalesDetails"> 
                                                    <i class="icon-eye"></i> Preview 
                                                </router-link>
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.editCashSales"> 
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.cashSalesDetails" class="text-sm text-default hover:text-primary">#CS0019</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">$870</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.cashSalesDetails" class="text-sm text-default hover:text-primary">#CS0018</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">$1,560</td>
                                ...
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                            <div class="p-2 space-y-1">
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.cashSalesDetails"> <i class="icon-eye"></i> Preview </router-link>
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.editCashSales"> 
                                                    <i class="icon-pencil-line"></i> Edit 
                                                </router-link>
                                                <a class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-danger hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" href="#" data-hs-overlay="#delete-modal"> 
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.cashSalesDetails" class="text-sm text-default hover:text-primary">#CS0017</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">1</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.cashSalesDetails" class="text-sm text-default hover:text-primary">#CS0016</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">$2,240</td>
                                <td class="py-2.5 px-2 text-sm text-default">Cash</td>
                                <td class="py-2.5 px-2">
                                    <span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Paid</span>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.cashSalesDetails" class="text-sm text-default hover:text-primary">#CS0015</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">Credit Card</td>
                                <td class="py-2.5 px-2">
                                    <span class="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">Refunded</span>
                                </td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown"> 
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.cashSalesDetails" class="text-sm text-default hover:text-primary">#CS0014</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">$1,130</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.cashSalesDetails" class="text-sm text-default hover:text-primary">#CS0013</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">3</td>
                                <td class="py-2.5 px-2 text-sm text-default">$785</td>
                                <td class="py-2.5 px-2 text-sm text-default">Cash</td>
                                <td class="py-2.5 px-2">
                                    <span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Paid</span>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.cashSalesDetails" class="text-sm text-default hover:text-primary">#CS0012</router-link>
                                </td>
                            ...
                            <tr>
                                <td class="py-2.5 px-2">
                                    <router-link :to="all_routes.cashSalesDetails" class="text-sm text-default hover:text-primary">#CS0011</router-link>
                                </td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">2</td>
                                <td class="py-2.5 px-2 text-sm text-default">$490</td>
                                <td class="py-2.5 px-2 text-sm text-default">Cash</td>
                                <td class="py-2.5 px-2">
                                    <span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Paid</span>
                                </td>
                ...
                <div class="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-border-color">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <button class="size-7 rounded-md text-sm border border-border-color flex items-center justify-center cursor-pointer text-default hover:bg-light ml-1">
                            <i class="ph ph-caret-left text-sm"></i>
                        </button>
                        <button class="size-7 rounded-md text-sm border border-border-color flex items-center justify-center cursor-pointer text-default hover:bg-light">
