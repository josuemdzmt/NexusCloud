        ...
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <div class="flex items-center gap-2">
                    <router-link :to="all_routes.salesQuotes" class="text-gray-900 hover:text-primary flex items-center text-sm">
                        <i class="ph ph-arrow-left"></i>
                    </router-link>
                    <h1 class="text-gray-900 text-base font-bold mb-0">Create New Sales Quote</h1>
                </div>
                <div class="flex items-center gap-2">
                    <router-link :to="all_routes.salesQuotesDetails" class="btn-sm bg-white border border-border-color text-gray-900 hover:bg-light cursor-pointer rounded-md shadow-sm inline-flex items-center">
            ...
            <div class="bg-white border border-border-color rounded-md p-5 shadow-sm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6 pb-6 border-b border-border-color">
                    <div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="border border-dashed border-border-color rounded-md p-6 text-center cursor-pointer hover:bg-light relative h-28">
                                ...
                                <p class="text-sm text-gray-600">Drop Your Files or 
                                    <span class="text-primary hover:underline font-medium">Browse</span>
                                </p>
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-gray-900 mb-5">Sales Quote Details</h2>
                        <div class="mb-4">
                            <label class="text-sm font-semibold text-gray-900 mb-2 block">Sales Quote ID 
                                <span class="text-danger">*</span>
                            </label>
                            <input type="text" class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-gray-50 focus:outline-none focus:ring-0 text-gray-600 dark:bg-gray-100" value="SQD0020" readonly>
                        </div>
                        <div class="mb-4">
                            <label class="text-sm font-semibold text-gray-900 mb-2 block">Date 
                                <span class="text-danger">*</span>
                            </label>
                            <a-date-picker v-model:value="quoteDate" class="w-full" placeholder="dd/mm/yyyy" />
                        </div>
                        <div class="mb-4">
                            <label class="text-sm font-semibold text-gray-900 mb-2 block">Payment Method 
                                <span class="text-danger">*</span>
                            </label>
                            <select class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-white focus:outline-none focus:ring-0">
                                <option>Select</option>
                ...
                <div class="grid xl:grid-cols-12 grid-cols-1 gap-8">
                    ...
                    <div class="space-y-4 xl:col-span-5 xxl:col-span-4">
                        <div class="flex items-center gap-4">  
                            ...
                            <input type="text" class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-white focus:outline-none focus:ring-0" value="0.00">
                        </div>
                        <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <input type="text" class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-gray-50 focus:outline-none focus:ring-0 text-gray-600 dark:bg-gray-100" value="0.00" readonly>
                        </div>
                    </div>
                </div>

                <div class="flex justify-end items-center gap-2 mt-5 pt-5 border-t border-border-color">
                    <button type="button" class="btn-sm bg-light border border-border-color text-gray-900 inline-flex items-center gap-2 hover:bg-dark hover:border-dark hover:text-white cursor-pointer">Make as Draft</button>
                    <button type="button" class="btn-sm bg-dark text-white border border-dark inline-flex items-center gap-2 hover:bg-primary-hover cursor-pointer">Save Invoice</button>
                </div>
