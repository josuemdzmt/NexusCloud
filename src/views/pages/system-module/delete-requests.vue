<template>
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl font-bold mb-0">Delete Requests</h1>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                ...
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Requisition Date</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Delete Request Date</th>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Nathan Brooks</span>
                                    </div>
                                </td>
                                <td class="py-2.5 px-2 text-sm text-default">11 Sep 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">26 Sep 2025</td>
                                <td class="py-2.5 px-2">
                                    <button class="size-7 rounded inline-flex items-center justify-center text-default hover:bg-danger-transparent hover:text-danger cursor-pointer" data-hs-overlay="#delete-modal"><i class="ph ph-trash"></i></button>
                                </td>
                            </tr>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Emma Collins</span>
                                    </div>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Elijah Cooper</span>
                                    </div>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Lily Anderson</span>
                                    </div>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Samuel Hayes</span>
                                    </div>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Hannah Scott</span>
                                    </div>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Logan Prince</span>
                                    </div>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Zoe Matthews</span>
                                    </div>
                                </td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Alexander Reed</span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-title">Natalie Perez</span>
                                    </div>
                                </td>
    ...
    <delete-requests-modal></delete-requests-modal>
</template>
