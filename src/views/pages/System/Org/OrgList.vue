<template>
  <main>
    <nx-list-view title="Organizaciones" object="org" @create="handleCreate">
      <nx-datatable object="org" key-field="id" :data="lstOrgs" :columns="lstColumns" :is-loading="bSpinner" :show-date-range="false"
