        ...
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <div class="flex items-center gap-2">
                    ...
                    <h1 class="text-gray-900 text-base font-bold mb-0">Edit Purchase Return</h1>
                </div>
                <div class="flex items-center gap-2">
            ...
            <div class="bg-white border border-border-color rounded-md p-5 shadow-sm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6 pb-6 border-b border-border-color">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-white focus:outline-none focus:ring-0" rows="4">Damaged goods received</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end items-center gap-2 mt-5 pt-5 border-t border-border-color">
                    <router-link :to="all_routes.purchaseReturn" class="btn-sm bg-light border border-border-color text-gray-900 inline-flex items-center gap-2 hover:bg-dark hover:border-dark hover:text-white cursor-pointer">Cancel</router-link>
