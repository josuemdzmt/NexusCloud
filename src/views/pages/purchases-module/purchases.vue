    ...
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl max-lg:text-lg font-bold mb-0">Purchases</h1>
                <div class="flex items-center flex-wrap gap-2">
                    ...
                    <router-link :to="all_routes.addPurchase" class="btn-sm bg-dark text-white border border-dark inline-flex items-center gap-2 hover:bg-primary-hover cursor-pointer"><i class="ph ph-plus"></i> Add New</router-link>
                </div>
            </div>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Reference</th>
                                ...
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Payment</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><router-link :to="all_routes.purchaseDetails" class="text-sm text-default hover:text-primary">#PUR0020</router-link></td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">Paid</td>
                                ...
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                            <div class="p-2 space-y-1">
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.purchaseDetails"> 
                                                    <i class="icon-eye"></i> Preview 
                                                </router-link>
                                                <router-link class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" :to="all_routes.editPurchase">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><router-link :to="all_routes.purchaseDetails" class="text-sm text-default hover:text-primary">#PUR0019</router-link></td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">Pending</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">Ordered</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                                <i class="icon-ellipsis-vertical font-normal"></i> </button>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><router-link :to="all_routes.purchaseDetails" class="text-sm text-default hover:text-primary">#PUR0018</router-link></td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><router-link :to="all_routes.purchaseDetails" class="text-sm text-default hover:text-primary">#PUR0017</router-link></td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">Partial</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><router-link :to="all_routes.purchaseDetails" class="text-sm text-default hover:text-primary">#PUR0016</router-link></td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><router-link :to="all_routes.purchaseDetails" class="text-sm text-default hover:text-primary">#PUR0015</router-link></td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><router-link :to="all_routes.purchaseDetails" class="text-sm text-default hover:text-primary">#PUR0014</router-link></td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><router-link :to="all_routes.purchaseDetails" class="text-sm text-default hover:text-primary">#PUR0013</router-link></td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2"><router-link :to="all_routes.purchaseDetails" class="text-sm text-default hover:text-primary">#PUR0012</router-link></td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">9</td>
                            ...
                            <tr>
                                <td class="py-2.5 px-2"><router-link :to="all_routes.purchaseDetails" class="text-sm text-default hover:text-primary">#PUR0011</router-link></td>
