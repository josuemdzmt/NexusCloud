        ...
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <div class="flex items-center gap-2">
                    <router-link :to="all_routes.purchaseOrders" class="text-gray-900 hover:text-primary flex items-center text-sm">
                        <i class="ph ph-arrow-left"></i>
                    </router-link>
                    <h1 class="text-gray-900 text-base font-bold mb-0">Create New Purchase Order</h1>
                </div>
                <div class="flex items-center gap-2">
                    <router-link :to="all_routes.purchaseOrderDetails" class="btn-sm bg-white border border-border-color text-gray-900 hover:bg-light cursor-pointer rounded-md shadow-sm inline-flex items-center">
            ...
            <div class="bg-white border border-border-color rounded-md p-5 shadow-sm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6 pb-6 border-b border-border-color">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            <label class="text-sm font-semibold text-gray-900 mb-2 block">Order Date 
                                <span class="text-danger">*</span>
                            </label>
                            <a-date-picker v-model:value="orderDate" class="w-full" placeholder="dd/mm/yyyy" />
                        </div>
                        <div class="mb-4">
                            <label class="text-sm font-semibold text-gray-900 mb-2 block">Expected Delivery Date
                                <span class="text-danger">*</span>
                            </label>
                            <a-date-picker v-model:value="expectedDeliveryDate" class="w-full" placeholder="dd/mm/yyyy" />
                        </div>
