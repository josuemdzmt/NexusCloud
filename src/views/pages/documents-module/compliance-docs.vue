<template>
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl max-lg:text-lg font-bold mb-0">Compliance Docs</h1>
                            ...
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                <div class="p-2 space-y-1">
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0" checked> Ethan Walker
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Madison Clark
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> James Harris
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Avery Thompson
                                    </label>
                                    <label class="flex items-center gap-2 text-sm cursor-pointer px-2 py-1.5 rounded-md hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white">
                                        <input type="checkbox" class="size-4 rounded border-border-color text-primary focus:ring-0"> Benjamin Wright
                                    </label>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                ...
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Regulator</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Period</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Submitted</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#CMP0020</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">ISO 9001 Certification</td>
                                <td class="py-2.5 px-2 text-sm text-default">ISO</td>
                                <td class="py-2.5 px-2 text-sm text-default">2024-2025</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#CMP0019</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">GDPR Compliance Checklist</td>
                                <td class="py-2.5 px-2 text-sm text-default">EU GDPR</td>
                                <td class="py-2.5 px-2 text-sm text-default">2024-2025</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#CMP0018</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Fire Safety Audit Report</td>
                                <td class="py-2.5 px-2 text-sm text-default">Local Fire Dept</td>
                                <td class="py-2.5 px-2 text-sm text-default">Q1 2025</td>
                                ...
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-danger-transparent text-danger px-2 py-0.5 rounded">Overdue</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                            <i class="icon-ellipsis-vertical font-normal"></i>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#CMP0017</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Environmental Compliance Form</td>
                                <td class="py-2.5 px-2 text-sm text-default">EPA</td>
                                <td class="py-2.5 px-2 text-sm text-default">2024-2025</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#CMP0016</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Workplace Safety Certificate</td>
                                <td class="py-2.5 px-2 text-sm text-default">OSHA</td>
                                <td class="py-2.5 px-2 text-sm text-default">2024-2025</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#CMP0015</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Data Privacy Impact Assessment</td>
                                <td class="py-2.5 px-2 text-sm text-default">Data Protection Auth</td>
                                <td class="py-2.5 px-2 text-sm text-default">2024-2025</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#CMP0014</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Vendor Compliance Agreement</td>
                                <td class="py-2.5 px-2 text-sm text-default">ISO / Local Govt</td>
                                <td class="py-2.5 px-2 text-sm text-default">2024-2025</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#CMP0013</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Employee Compliance Training</td>
                                <td class="py-2.5 px-2 text-sm text-default">HR Dept</td>
                                <td class="py-2.5 px-2 text-sm text-default">2024-2025</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#CMP0012</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Anti-Bribery Policy Record</td>
                                <td class="py-2.5 px-2 text-sm text-default">Local Govt</td>
                                <td class="py-2.5 px-2 text-sm text-default">2024-2025</td>
                            ...
                            <tr>
                                <td class="py-2.5 px-2 text-sm text-default">
                                    <a href="#" class="text-sm text-default hover:text-primary">#CMP0011</a>
                                </td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Internal Audit Report Q1 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">Internal Audit</td>
                                <td class="py-2.5 px-2 text-sm text-default">Q1 2025</td>
    ...
    <compliance-docs-modal></compliance-docs-modal>
</template>
