<template>
    <main>
        <div class="p-3 lg:py-6 lg:px-0">
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl max-lg:text-lg font-bold mb-0">Policies &amp; Manuals</h1>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                ...
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Last Review</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Retention</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">3 Years</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Published</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                            ...
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Code of Conduct Policy</td>
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">4 Years</td>
                            ...
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">5 Years</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-info-transparent text-info px-2 py-0.5 rounded">Draft</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                            <i class="icon-ellipsis-vertical font-normal"></i>
                            ...
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Leave &amp; Attendance Policy</td>
                                <td class="py-2.5 px-2 text-sm text-default">Policy</td>
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">2 Years</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Published</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Procurement Process Manual</td>
                                <td class="py-2.5 px-2 text-sm text-default">Manual</td>
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                            ...
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Health &amp; Safety Policy</td>
                                <td class="py-2.5 px-2 text-sm text-default">Policy</td>
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                            ...
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Training &amp; Development Manual</td>
                                <td class="py-2.5 px-2 text-sm text-default">Manual</td>
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                                ...
                                <td class="py-2.5 px-2 text-sm text-default">6 Years</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Published</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900 focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Data Privacy Policy</td>
                                <td class="py-2.5 px-2 text-sm text-default">Policy</td>
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                            ...
                            <tr class="border-b border-border-color">
                                ...
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Performance Review Manual</td>
                                <td class="py-2.5 px-2 text-sm text-default">Manual</td>
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
                            ...
                            <tr>
                                ...
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Remote Work Policy</td>
                                <td class="py-2.5 px-2 text-sm text-default">Policy</td>
                                <td class="py-2.5 px-2">
                                    <div class="flex items-center gap-2">
    ...
    <policies-manuals-modal></policies-manuals-modal>
</template>
