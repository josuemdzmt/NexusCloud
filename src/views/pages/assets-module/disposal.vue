    ...
    <main>
        ...
        <div class="p-3 lg:py-6 lg:px-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mb-3 lg:mb-6">
                <h1 class="text-gray-900 text-xl font-bold mb-0">Disposal</h1>
                <div class="flex items-center gap-2 flex-wrap">
                    ...
                    <button type="button" class="btn-sm bg-dark text-white border border-dark inline-flex items-center gap-2 hover:bg-primary-hover hover:border-primary-hover cursor-pointer" data-hs-overlay="#add-disposal-modal"><i class="ph ph-plus"></i> Add New</button>
                </div>
            </div>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-sm text-default border-b border-border-color">
                                ...
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Method</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Value</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Date</th>
                                <th class="text-left py-2 px-2 font-semibold text-gray-900">Approved By</th>
                        ...
                        <tbody>
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DIP0020</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Dell Latitude</td>
                                <td class="py-2.5 px-2 text-sm text-default">Sold</td>
                                <td class="py-2.5 px-2 text-sm text-default">$1,200</td>
                                ...
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-50 bg-white border border-border-color shadow rounded-md mt-2 z-1" role="menu" aria-orientation="vertical" tabindex="-1">
                                            <div class="p-2 space-y-1">
                                                <a class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-gray-900 hover:bg-light hover:text-gray-900 focus:outline-hidden focus:bg-white" href="#" data-hs-overlay="#edit-disposal-modal">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DIP0018</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">HP LaserJet Pro MFP</td>
                                <td class="py-2.5 px-2 text-sm text-default">Auction</td>
                                ...
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-info-transparent text-info px-2 py-0.5 rounded">Approved</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                            <i class="icon-ellipsis-vertical font-normal"></i> </button>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DIP0017</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">iPhone 14</td>
                                <td class="py-2.5 px-2 text-sm text-default">Recycled</td>
                                <td class="py-2.5 px-2 text-sm text-default">$1,099</td>
                                <td class="py-2.5 px-2 text-sm text-default">16 Aug 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">IT Manager</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-success-transparent text-success px-2 py-0.5 rounded">Completed</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DIP0016</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">MacBook Pro 16"</td>
                                <td class="py-2.5 px-2 text-sm text-default">Sold</td>
                                <td class="py-2.5 px-2 text-sm text-default">$2,500</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DIP0015</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">AC Unit</td>
                                <td class="py-2.5 px-2 text-sm text-default">Scrapped</td>
                                <td class="py-2.5 px-2 text-sm text-default">$1,800</td>
                                <td class="py-2.5 px-2 text-sm text-default">12 Jul 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">Facility Head</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-info-transparent text-info px-2 py-0.5 rounded">Approved</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DIP0014</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Conference Table</td>
                                <td class="py-2.5 px-2 text-sm text-default">Donated</td>
                                <td class="py-2.5 px-2 text-sm text-default">$1,000</td>
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DIP0013</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">CCTV Camera Set</td>
                                <td class="py-2.5 px-2 text-sm text-default">Recycled</td>
                                <td class="py-2.5 px-2 text-sm text-default">$900</td>
                                <td class="py-2.5 px-2 text-sm text-default">07 Jun 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">Security Head</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-warning-transparent text-warning px-2 py-0.5 rounded">Pending</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr class="border-b border-border-color">
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DIP0012</a></td>
                                <td class="py-2.5 px-2 text-sm font-semibold text-title">Forklift Machine</td>
                                <td class="py-2.5 px-2 text-sm text-default">Sold</td>
                                <td class="py-2.5 px-2 text-sm text-default">$6,500</td>
                                <td class="py-2.5 px-2 text-sm text-default">28 May 2025</td>
                                <td class="py-2.5 px-2 text-sm text-default">Operations Head</td>
                                <td class="py-2.5 px-2"><span class="text-[11px] bg-info-transparent text-info px-2 py-0.5 rounded">Approved</span></td>
                                <td class="py-2.5 px-2">
                                    <div class="hs-dropdown [--placement:bottom-right] [--auto-close:inside] relative inline-flex">
                                        <button type="button" class="hs-dropdown-toggle cursor-pointer btn-sm size-7 bg-white border border-border-color text-gray-600 inline-flex items-center justify-center hover:bg-light hover:border-light hover:text-gray-900 focus:bg-light focus:border-light focus:text-gray-900  focus:outline-hidden" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            ...
                            <tr>
                                <td class="py-2.5 px-2 text-sm text-default"><a href="#">#DIP0011</a></td>
